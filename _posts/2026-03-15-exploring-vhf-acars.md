...
<div class="section-card">
  ...
  <div class="info-box">
    ...
    ACARS operates across multiple communication mediums: <strong>VHF (Very High Frequency)</strong> for short-range line-of-sight communication, <strong>HF (High Frequency)</strong> for long-distance oceanic communication, and <strong>SATCOM (Satellite Communication)</strong> for global coverage via systems such as Inmarsat.
  </div>
</div>
